...
void ZZSelectorBase::SetScaleFactors()
{
  ...
  try{
    ...
    if (yearcfg == "2016"){
      if (name_.find("_postVFP") != std::string::npos)
        yearcfg = "2016postVFP";
      else
        yearcfg = "2016preVFP";
    }
    yearstring = yearcfg + "_UL";
  }
  catch (...){
...
void ZZSelectorBase::SetBranchesUWVV()
{
  ...
  if (channel_ == eeee)
  {
    ...
    fChain->SetBranchAddress("e4PVDZ", &l4PVDZ, &b_l4PVDZ);
    fChain->SetBranchAddress("e1Energy", &l1Energy, &b_l1Energy);
    fChain->SetBranchAddress("e2Energy", &l2Energy, &b_l2Energy);
    fChain->SetBranchAddress("e3Energy", &l3Energy, &b_l3Energy);
    fChain->SetBranchAddress("e4Energy", &l4Energy, &b_l4Energy);
  ...
  else if (channel_ == mmmm)
  {
    ...
    fChain->SetBranchAddress("m4PVDZ", &l4PVDZ, &b_l4PVDZ);
    fChain->SetBranchAddress("m1Energy", &l1Energy, &b_l1Energy);
    fChain->SetBranchAddress("m2Energy", &l2Energy, &b_l2Energy);
    fChain->SetBranchAddress("m3Energy", &l3Energy, &b_l3Energy);
    fChain->SetBranchAddress("m4Energy", &l4Energy, &b_l4Energy);
  ...
  else if (channel_ == eem)
  {
    ...
    fChain->SetBranchAddress("mEnergy", &l3Energy, &b_l3Energy);
  ...
  else if (channel_ == emm)
  {
    ...
    fChain->SetBranchAddress("eEnergy", &l3Energy, &b_l3Energy);
